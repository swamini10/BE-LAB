...
# Algorithm Steps:
# Input items with their weights and values.
# Calculate value-to-weight ratio for each item → value / weight.
# Sort items in descending order of this ratio (highest first).
# → This ensures we pick the most valuable items first.
...
# Calculate total value of all selected items (full or fractional).